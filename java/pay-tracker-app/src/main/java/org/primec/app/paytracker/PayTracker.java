...
import org.primec.app.paytracker.util.LocalDateTimeDeserializer;
 ...
 */
import org.primec.app.paytracker.handler.PaymentHandler;
import org.primec.app.paytracker.handler.CurrencyHandler;
import org.primec.app.paytracker.handler.PayerHandler;
import org.primec.app.paytracker.handler.PaymentProcessorHandler;

import org.primec.app.paytracker.db.DbHelper;
...
public class PayTracker {
    ...
    private final LinkedBlockingDeque<MuServer> muServerPool =
    ...
    private static void loadPropertiesFromConfigFile() {
        ...
        if (PayTracker.properties.isEmpty()) {
    ...
    public int totalConnections() {
        assert !this.muServerPool.isEmpty();
